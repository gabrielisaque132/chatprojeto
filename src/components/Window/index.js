      ...
      <div className="chatWindow--header">
        <div className="chatWindow--headerinfo">
          <img
            ...
            src="https://www.dreamstime.com/default-avatar-profile-flat-icon-social-media-user-vector-portrait-unknown-human-image-default-avatar-profile-flat-icon-image184330869"
            alt="chat-avatar"
          />
          <div className="chatWindow--name">Gabriel Isaque</div>
        </div>
